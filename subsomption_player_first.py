...
SensorRotation=[0.5502660264639347, 0.09213023476856247, 0.39117737828516036, 0.23924323159761426, 0.21457483879048778, 0.6295466662298833, 0.18291551327478234, 0.6605410007246855]
...
class Agent(object):
    ...
    def step(self):
        ...
        if evite_joueur==True :
            self.setRotationValue(SensorRotation[sensor_actif])
            self.setTranslationValue(1)
